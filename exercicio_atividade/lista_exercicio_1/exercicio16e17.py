...
print("Quantidade de galões de 3,6 litros necessários: ", galoes)
print("Quantidade de latas de 18 litros necessárias: ", latas)
print("Quantidade de latas de 18 litros necessárias na mistura: ", latas_mistura)
print("Quantidade de galões de 3,6 litros necessários na mistura: ", galoes_mistura)